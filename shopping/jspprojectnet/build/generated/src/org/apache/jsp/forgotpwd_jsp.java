...
if(cookies!=null)
{
    for(int i=0;i<=cookies.length-1;i++)
    {
      ...
      out.write("\t\t\t\t\t\t<button class=\"w3view-cart\" type=\"submit\" name=\"submit\" value=\"\"><i class=\"fa fa-cart-arrow-down\" aria-hidden=\"true\"><a href=\"showcart.jsp\"></i></button>\n");
      out.write("\t\t\t\t\t</form>  \n");
      out.write("\t\t\t</div>\n");
...
catch(Exception e)
{
    out.print("Error in connection"+e.getMessage());
      ...
      out.write("\t\t<div class=\"container\">\n");
      out.write("\t\t\t<h2>Password Recovery Form</h2>\n");
      out.write("\t\t\n");
      ...
      out.write("\t\t\t\t\t\t<\n");
      out.write("\t\t\t\t\t\t<li><i class=\"fa fa-arrow-right\" aria-hidden=\"true\"></i><a href=\"products.jsp\">Special Products</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"col-md-3 w3_footer_grid\">\n");
      ...
      out.write("\t\t\t\t\t<ul class=\"info\"> \n");
      out.write("\t\t\t\t\t\t<li><i class=\"fa fa-arrow-right\" aria-hidden=\"true\"></i><a href=\"products.jsp\">Store</a></li>\n");
      out.write("\t\t\t\t\t\t<li><i class=\"fa fa-arrow-right\" aria-hidden=\"true\"></i><a href=\"showcart.jsp\">My Cart</a></li>\n");
