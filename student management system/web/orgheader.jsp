			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<!-- Mega Menu -->
									<li class="dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown">Proceed to take food<b class="caret"></b></a>
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												<div class="multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>Get Food</h6>
                                                                                                                <li><a href="restable.jsp"></a>Pick Food</li>
													</ul>
												</div>	
											...
											<div class="row">
												<div class="multi-gd-img">
													<ul class="multi-column-dropdown">
														...
														<li><a href="listoforg.jsp">List of Restaurant</a></li>
