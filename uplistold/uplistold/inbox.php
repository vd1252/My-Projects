	...
	<div id="fh5co-gallery">
		...
		<div class="container-fluid">
				...
				<div class="col-md-8  fh5co-heading animate-box">
					...
					<?php
					 $id=$_SESSION['uid'];
					 $querym="select m.*,r.* from message m join register r on m.sender_id=r.reg_id where m.reciever_id=$id";
					...
					<div class="row row-bottom-padded-md" style="padding-bottom:40px;">
					 ...
					 {
						 echo "<h4 class='text-center alert alert-warning'>There no messages you recieved</h4>";
					 }
						?>
