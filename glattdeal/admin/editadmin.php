...
$catmsg="";
$id=$_GET['admin_id'];
$regequery="select * from login where id=$id";
...
if(isset($_POST['btnsubmit']))
 { 
	...
	$queryupd="update login set username='$name',password='$pass',email='$email',image='$imgpath' where id=$id";
				...
				<div class="card-body collapse in">
					<div class="card-block">
						...
						<form class="form" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label>Email</label>
									<input type="text" id="companyName" class="form-control" name="txtemail" value="<?php echo $regerow['email'];?>" >
								</div>
								<div class="form-group">
