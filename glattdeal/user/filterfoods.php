...
<body>
    ...
    <div class="form-price-range-filter">
        <form method="post" action="filterfoods.php">
            <div>
            ...
            <div>
                        ...
                        ?>  
                                ...
                                <li>
                                    ...
                                    <div class="thumb-list-item-caption">
                                        <h5 class="thumb-list-item-title"><a href="product-details.php?deal_id=<?php
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="product-sort">
                                ...
                                <ul>
                                    <li><a href="sortbyname.php">sort by Name</a>
                                    </li>
                                    <li><a href="sortbyprice.php">sort by Price </a>
                                    </li>
                    ...
                    <div class="row row-wrap">
                        ...
                        $dealquery="select * from deal where dealcat_id=1 and deal_totalamount BETWEEN '$min' AND '$max'";
                        $dealres=mysqli_query($con,$dealquery);
                        $count = mysqli_num_rows($dealres);
                        if ($count > 0) {
