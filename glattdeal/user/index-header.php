...
if(isset($_POST['btnnsubmit']))
 { 
	 ...
	 $time2=$_POST['txttime2'];
     move_uploaded_file($_FILES['profile']['tmp_name'],"images/".$_FILES['profile']['name']);
    $profile="images/".$_FILES['profile']['name'];
$rquery="insert into supplier(sup_name,sup_email,sup_password,profile,sup_status,sup_address,sup_contact,sup_info,start_time,end_time) values('$supname','$email','$password','$profile','$status','$address','$phoneno','$detail','$time1','$time2')";
	 $rres=mysqli_query($con,$rquery);//true/false
	 if($rres)
	 {
   ...
   $( document ).ready( function () {
	...
	$("#register2-dialogsupplier").validate({
		...
		messages:
		{
            ...
            txttime1:"Please enter time in this format 11:00 AM To 11:00 PM",
			txttime2:"Please enter time in this format 11:00 AM To 11:00 PM",
...
<body class="boxed" style="background-image: url(img/backgrounds/background.jpg); background-attachment: fixed;">
    ...
    ////////////////////////////////////-->
        ...
        <div id="login-dialog" class="mfp-with-anim mfp-hide mfp-dialog clearfix">
            ...
            <form method="post" enctype="multipart/form-data" class="dialog-form">
                <div class="form-group">
                    <label>E-mail</label>
                    <input type="text" placeholder="email@domain.com" class="form-control" name="txtemail" required="">
                </div>
                <div class="form-group">
                    <label>Password</label>
                    <input type="password" placeholder="My secret password" class="form-control" name="txtpass" required="">
                </div>
                <div class="checkbox">
                    <label>
        ...
        <div id="register-dialog" class="mfp-with-anim mfp-hide mfp-dialog clearfix">
            ...
            <form action="" method="post" id="register-form" enctype="multipart/form-data" class="dialog-form" >
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>E-mail</label>
                    <input type="text" placeholder="email@domain.com" class="form-control" name="Email" required="">
                </div>
                <div class="form-group">
                    <label>Password</label>
                    <input type="password" placeholder="My secret password" class="form-control" name="password" required="">
                </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input  type="text" placeholder="Contact No" class="form-control" name="phoneno" required="">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Profile Photo</label>
                            <input id="reg-photo" type="file" class="form-control" name="profile" required="">
                        </div>
                    </div>
                </div>
        ...
        <div id="login-dialogsupplier" class="mfp-with-anim mfp-hide mfp-dialog clearfix">
            ...
            <form method="post" enctype="multipart/form-data" class="dialog-form">
                <div class="form-group">
                    <label>E-mail</label>
                    <input type="text" placeholder="email@domain.com" class="form-control" name="textemail" required="">
                </div>
                <div class="form-group">
                    <label>Password</label>
                    <input type="password" placeholder="My secret password" class="form-control" name="textpass" required="">
                </div>
                <div class="checkbox">
                    <label>
                        <input type="checkbox">Remember me
        ...
        <div id="register-dialogsupplier" class="mfp-with-anim mfp-hide mfp-dialog clearfix "style="max-height: 997px !important;max-width: 483px !important;">
            ...
            <form method="post" id="register2-dialogsupplier" enctype="multipart/form-data" class="dialog-form">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Supplier Name" class="form-control" name="txtname" required="">
                </div>
                ...
                <div class="form-group">
                    <label>Detail</label> 
                    <input type="text" placeholder="Detail" class="form-control" name="txtdetail" required="">
                </div>
                <div class="form-group">
                    <label>Starting Time</label> 
                    <input type="text" placeholder="start time" class="form-control" name="txttime1" required="">
                </div>
				<div class="form-group">
                    <label>End Time</label> 
                    <input type="text" placeholder="end time" class="form-control" name="txttime2" required="">
                </div>
