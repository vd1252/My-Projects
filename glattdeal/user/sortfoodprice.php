            ...
            <div>
                <input type="submit" name="submit_range"
                    value="Filter Deal" class="btn-submit" >
                        ...
                        ?>  
                                ...
                                <li>
                                    <a href="#">
                                        <img src="<?php echo $dealrow['dealimage_1'];?>" alt="Image Alternative text"  />
                                    </a>
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <span class="product-sort-selected">sort by&nbsp; &nbsp; </span>
                                ...
                                <ul>
                                    <li><a href="sortfood.php">sort by Name</a>
                                    </li>
                                    <li><a href="sortfoodprice.php">sort by Price </a>
                                    </li>
                    ...
                    <div class="row row-wrap">
						...
						$dealquery="select * from deal where dealcat_id=1 order by deal_totalamount asc ";
						$dealres=mysqli_query($con,$dealquery);
						while($dealrow=mysqli_fetch_array($dealres))
						{
						?>	
