...
try {
    ...
    //Recipients
    $mail->setFrom('allovedeal12@gmail.com', 'Alloverdeal');
    ...
    $url = "http://".$_SERVER["HTTP_HOST"]. dirname($_SERVER["PHP_SELF"])."/reset-password-sup.php?code=$code";
        ...
        <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
            <div class="card-header no-border pb-0">
                <div class="card-title text-xs-center">
                    <img src="img/logos/allover-deal-logo.png" alt="branding logo">
                </div>
                ...
                <div class="card-block">
                    <form method="POST"   class="form-horizontal" novalidate>
                        <fieldset class="form-group position-relative has-icon-left">
                            <input  name="sup_email" type="email" class="form-control form-control-lg input-lg" id="user-email" placeholder="Your Email Address" required>
            ...
            <div class="card-footer no-border">
                <p class="float-sm-left text-xs-center"><a href="index.php" class="card-link"><i class="icon-arrow-left"></i> &nbsp;Back to Main Page </a></p>
