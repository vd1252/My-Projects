    ...
    <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                ...
                <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Password Updated </span></h6> 
                <button  type="submit" name="btnlogin" class="btn btn-primary btn-lg btn-block"><i class="icon-unlock2"></i> <a style="color:white"; href="index.php" > Login</a> </button>
