                ...
                <div class="row">
                            ...
                            <ul class="nav nav-pills flexnav" id="flexnav" data-breakpoint="800">
                                ...
                                <li><a href="#">About Us</a>
                                    <ul>
										...
										<li><a href="user-setting.php">My Account</a>
                                            <ul>
                                                <li><a href="user-setting.php">Settings</a>
                                                </li>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="login-register">
                            ...
                            <li><a  href="logout.php" data-effect="mfp-move-from-top"><i class="fa fa-sign-in"></i>Logout</a>
                            </li>
