						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
                                                    ...
                                                    if(session.getAttribute("uname")!=null)
                                                    {
                                                        ...
                                                        out.print("<li><a href='changepassshop.jsp'>Change Password</a></li>");
		...
		<div class="header">
			...
			<div class="container">
					...
					<nav class="navbar navbar-default" role="navigation">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
                                                            <li class="active"><a href="shopkeeper.jsp">Home</a></li>
                                                            <li class="dropdown">
                                                              <a class="dropdown-toggle" data-toggle="dropdown" href="#">Add
                                                              <span class="caret"></span></a>
                                                              <ul class="dropdown-menu">
                                                                
                                                                <li><a href="addmenushop.jsp">Add Menu</a></li>
                                                                <li><a href="addfoodtypeshop.jsp">Add Food Type</a></li>
                                                            ...
                                                            <li class="dropdown">
                                                              ...
                                                              <ul class="dropdown-menu">
                                                                ...
                                                                <li><a href="managefoodtypeshop.jsp">Manage Food Type</a></li>
                                                                <% out.print("<li><a href='updaterestaurant.jsp?rid="+ session.getAttribute("rid") +"'>Update Restaurant details </a></li>"); %>
                                                                <li><a href="managemenu.jsp">Manage Menu</a></li>
                                                            ...
                                                            <li class="dropdown">
                                                              ...
                                                              <ul class="dropdown-menu">
                                                                <li><a href="listoforders.jsp">List Of Orders</a></li>
