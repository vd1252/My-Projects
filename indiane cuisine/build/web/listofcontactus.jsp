...
<html>
	...
	<!----to include header portion------------>
        ...
        try
        {
            ...
            try
            {
                String qu2="select count(*) from contactus ";
                int total_records=0;
                ...
                String qu="select name,email,msg from contactus order by name desc limit " + offset + "," + records_per_page;
                PreparedStatement myst=myconnection.prepareStatement(qu);
                myres=myst.executeQuery();
                }
                else 
                {
                    String qu="select name,email,msg from contactus where name like ? order by name";
                    PreparedStatement myst=myconnection.prepareStatement(qu);
                    ...
                    for(int x=1;x<=totalpages;x++)
                            {
                                ...
                                {
                                    out.print("<a href=listofcontactus.jsp?pageno=" + x + ">" + x + "</a>");
                                }
