    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h4><i class="fas fa-hotel"></i> Table Booking</h4>
        </div>
            ...
            <div class="item active">
                    <ul class="thumbnails">
                        <li class="col-sm-3">
    						<div class="fff">
								<div class="thumbnail" style="background-color: #acafa3">
                                                                    <img src="images/offer1 (5).jpg" alt="" style="height:150px;width:250px">
								</div>
                                                  </div>
                        </li>
                        <li class="col-sm-3">
    						<div class="fff">
								<div class="thumbnail" style="background-color: #acafa3">
                                                                    <img src="images/offer1 (1).jpg" alt="" style="height:150px;width:250px">
								</div>
                                                </div>
                        </li>
                         <li class="col-sm-3">
    						<div class="fff">
								<div class="thumbnail" style="background-color: #acafa3">
                                                                    <img src="images/offer1 (2).jpg" alt="" style="height:150px;width:250px">
								</div>
						 </div>
                        </li>
                       <li class="col-sm-3">
    						<div class="fff">
								<div class="thumbnail" style="background-color: #acafa3">
                                                                    <img src="images/offer1 (3).jpg" alt="" style="height:150px;width:250px">
								</div>
						 </div>
                        </li>
                    </ul>
            ...
            <div class="item">
                    <ul class="thumbnails">
                       <li class="col-sm-3">
    						<div class="fff">
								<div class="thumbnail" style="background-color: #acafa3">
                                                                    <img src="images/offer1 (4).jpg" alt="" style="height:150px;width:250px">
								</div>
						 </div>
                        </li>
                        <li class="col-sm-3">
	...
	<div class="quick">
		<div class="container">
			<div class="col-md-4 quick-left">
                            <h3>We are live in these Cities</h3>
