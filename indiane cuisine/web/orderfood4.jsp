...
{                                                          String myURL="", myUNAME="", myPASS="";
    ...
    try
            {
                String qu2="select count(*) from resturant where rid=?";
                int total_records=0;
            ...
            do{
  			...
  			<div class="col-md-6 tels-left">
				...
				<div class="col-md-6 single-left">
					<a href="details.html"><img src="<% out.print("cimages/"+myres.getString("image"));%>" class="img-responsive" alt="" height="1000px" width="300px"></a>
                                        
				</div>
				<div class="col-md-6 single-right">
                                    <h1><a href="details.html"><%out.print(myres.getString("rname"));%></a></h1><br>
...
%>
                            ...
                            <center>
                                <ul class="pagination">
                                  ...
                                  <li class="page-item"><a class="page-link" href=orderfood4.jsp?pageno="<% out.print(x); %>"><% out.print(x); %></a></li>
