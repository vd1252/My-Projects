...
{                                                          String myURL="", myUNAME="", myPASS="";
    ...
    try
            {
                String qu2="select count(*) from resturant where locality_id=?";
                int total_records=0;
                PreparedStatement myst2=myconnection.prepareStatement(qu2);
                myst2.setString(1,request.getParameter("locality_id"));
            ...
            do{
  			...
  			<div class="col-md-6 tels-left">
				...
				<div class="col-md-6 single-left">
                                    <a href="restaurantetails.jsp?rid=<% out.print(myres.getString("rid")); %>"><img src="<% out.print("cimages/"+myres.getString("image"));%>" class="img-responsive" alt="" height="1000px" width="300px"></a>
                                        
				</div>
				<div class="col-md-6 single-right">
                                    <h1><a href="restaurantetails.jsp?rid=<% out.print(myres.getString("rid")); %>"><%out.print(myres.getString("rname"));%></a></h1><br>
					...
					<div class="sinbt">
						<a class="hvr-shutter-in-horizontal" href="<% out.print("restaurantetails.jsp?rid="+myres.getString("rid")); %>">View Restaurant</a>
					</div>
				</div>
...
%>
                            ...
                            <center>
                                <ul class="pagination">
                                  ...
                                  <li class="page-item"><a class="page-link" href=orderfood3.jsp?pageno="<% out.print(x); %>"><% out.print(x); %></a></li>
