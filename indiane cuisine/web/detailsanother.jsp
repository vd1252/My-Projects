...
<style>
 ...
 body {
  ...
  #section1 {margin-left: 27px;padding-top:50px;padding-left:50px;padding-right:50px;height:500px;color: black; background-color: #F3F3F3;}
  #section2 {margin-left: 27px;padding-top:50px;padding-left:50px;padding-right:50px;height:500px;color: black; background-color: #F3F3F3;}
  #section3 {margin-left: 27px;padding-top:50px;padding-left:50px;padding-right:50px;height:500px;color: black; background-color: #F3F3F3;}
  #section4 {margin-left: 27px;padding-top:50px;padding-left:50px;padding-right:50px;height:500px;color: black; background-color: #F3F3F3;}
  </style>
</head>
                                 ...
                                 %>
                                   <div class="panel-body mypanel"  >
                                    <div class="container-fluid" style="padding-left:0px;margin-left: 0px">
                                        <div class="col-md-8">
                                            <div id="panel1">
                                                <img class="sign" src="<% out.print("cimages/"+myresfoodmenu.getString("image")); %>" width="50px" height="50px" ><span class="myfont2"><% out.print(myresfoodmenu.getString("itemname")); %></span>
...
<%
                    ...
                    <div class="row brand-cart-sidebar-main">
                     ...
                     <div class="row">
                        <div class="panel panel-default" >
                            <div class="panel-body"style="position:fixed;bottom:0px;z-index: 3px;width:427px;background-color: #F3F3F3;">
                                <h1>Subtotal</h1><br><br>
                                <div class="sinbt">
                                            <a class="hvr-shutter-in-horizontal" href="checkout.jsp?rid=<% out.print(myres.getString("rid")); %> " height="250px" width="250px" >Continue</a>
                                </div>
                            </div>
                      </div>
                    </div>
